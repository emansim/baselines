...
from baselines.retrieval_control.ddpg_retrieval_nonlearned import DDPG
...
def train(env, nb_epochs, nb_epoch_cycles, render_eval, reward_scale, render, param_noise, actor, critic,
    ...
    demons, fingertip_coms_start, target_coms_start, top_k=1, retrieved_action_prob=0.99,
        ...
        for epoch in range(nb_epochs):
            ...
            for cycle in range(nb_epoch_cycles):
                ...
                for t_rollout in range(nb_rollout_steps):
                    # Predict next action.
                    action, q = agent.pi(obs, retrieved_actions[t_episode], retrieved_action_prob, apply_noise=True, compute_Q=True)
                ...
                if eval_env is not None:
                    ...
                    for t_rollout in range(nb_eval_steps):
                        eval_action, eval_q = agent.pi(eval_obs, eval_retrieved_actions[eval_t_episode], retrieved_action_prob, apply_noise=False, compute_Q=True)
